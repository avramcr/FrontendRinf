  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const response = await fetch(
        `http://localhost:3000/comenzi/${id}/retrimite`,
        {
          method: "PATCH",
          headers: {
      ...
      if (response.ok) {
        setMsg("Comanda a fost modificată și retrimisă cu succes!");
        setTitlu("");
        setDescriere("");
        setCategorie("");
        setSuma("");
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {loading ? "Se retrimite..." : "Retrimite comanda"}
        </button>
